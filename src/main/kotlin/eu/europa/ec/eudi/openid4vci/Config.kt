...
data class OpenId4VCIConfig(
    ...
    val authorizeIssuanceConfig: AuthorizeIssuanceConfig = AuthorizeIssuanceConfig.AUTHORIZATION_DETAILS,
    val dPoPSigner: PopSigner.Jwt? = null,
    val verifierKA: VerifierKA? = null,
    val clientAttestationProvider: ClientAttestationProvider? = null,
